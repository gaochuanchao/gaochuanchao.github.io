...
### Centralized Approximation Algorithms for Real-Time Edge Computing

#### 1. Real-time task offloading in mobile edge computing
...
#### 2. Forwarding-enabled real-time offloading in mobile edge computing
...
### Distributed Approximation Algorithms for Real-Time Edge Computing
