...
### 2025
- `Chuanchao Gao`, Arvind Easwaran, "Real-Time Service Subscription and Adaptive Offloading Control in Vehicular Edge Computing", 2025 IEEE Real-Time Systems Symposium (RTSS), Boston, MA, USA, 2025. [HTML] [[Download]](../papers/Real-Time Service Subscription and Adaptive Offloading Control in Vehicular Edge Computing.pdf) [[Open Source Project: mecRT]](https://github.com/gaochuanchao/mecRT/tree/main/src) 
